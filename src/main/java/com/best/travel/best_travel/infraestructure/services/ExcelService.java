...
public class ExcelService implements IReportService {
    ...
    private void createReport(){
        ...
        var headerCell1 = headerRow.createCell(0);
        headerCell1.setCellValue(COLUMN_CUSTOMER_ID);
        headerCell1.setCellStyle(headerStyle);

        var headerCell2 = headerRow.createCell(1);
        headerCell2.setCellValue(COLUMN_CUSTOMER_NAME);
        headerCell1.setCellStyle(headerStyle);

        var headerCell3 = headerRow.createCell(2);
        headerCell3.setCellValue(COLUMN_CUSTOMER_PURCHASES);
        headerCell1.setCellStyle(headerStyle);
        ...
        for (CustomerEntity customer : customers) {
            ...
            cell1.setCellValue(customer.getDni());
            cell1.setCellStyle(style);

            var cell2 = row.createCell(1);
            cell2.setCellValue(customer.getFullName());
            cell2.setCellStyle(style);

            var cell3 = row.createCell(2);
            cell3.setCellValue(getTotalPurchases(customer));
        ...
        try(var outputStream = new FileOutputStream(fileLocation)){
            ...
            throw new RuntimeException("Can´t create Excel file", e);
        }
    }

    private static final Integer getTotalPurchases(CustomerEntity customer) {
