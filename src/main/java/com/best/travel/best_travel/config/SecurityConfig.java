...
public class SecurityConfig {
    ...
    public SecurityConfig(@Qualifier(value = "userService") UserDetailsService userDetailsService) {
    ...
    public TokenSettings tokenSettings() {
        return TokenSettings.builder()
                .refreshTokenTimeToLive(java.time.Duration.ofDays(8))
                .build();
    }
            ...
            if (context.getTokenType().equals(OAuth2TokenType.ACCESS_TOKEN)) {
                context.getClaims().claims(claim ->{
                    claim.putAll(Map.of(
                        ...
                        "date_requeste", LocalDateTime.now().toString()
                    ));
                });
    ...
    private static final String APPLICATION_OWNER = "Crisda 24";
